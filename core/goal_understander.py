...
class GoalUnderstander:
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "  - If the goal mentions a specific file path (e.g. utils/paths.py, src/app.py), set\n"
            "    working_directory to the PROJECT ROOT that would contain that file. Do not include the\n"
            "    filename itself.\n"
            "  - If the goal says \"in my project\", \"in this repo\", or similar, set working_directory to\n"
            "    the user's projects_dir from profile if known, otherwise null.\n"
            "  - If the goal is about modifying, adding to, or fixing something in an existing codebase,\n"
            "    set working_directory to the most reasonable project root.\n"
            "  - For greenfield goals (\"build X from scratch\", \"create a new Y\"), set working_directory to\n"
            "    null.\n"
